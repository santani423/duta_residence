...
class User extends Authenticatable
{
    ...
    /**
     * Overrides the framework default so the emailed link points at the SPA's
     * /reset-password route instead of a `password.reset` named route this
     * API-only app never defines.
     */
