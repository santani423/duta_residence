...
export const api = {
  ...
  resident: {
    ...
    balanceLedger: (params) => http.get('/resident/balance/ledger', { params }),
    previewBalanceUsage: (payload) => http.post('/resident/balance/preview', payload),
    useBalance: (payload) => http.post('/resident/balance/use', payload),
