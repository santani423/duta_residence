// Dummy/placeholder content for the public landing page.
// Replace with real API data once the corresponding backend modules
// (news, facilities, partners, testimonials) are available.
...
export const NAV_LINKS = [
  ...
  { key: 'fasilitas', label: 'Fasilitas', href: '#fasilitas' },
  { key: 'berita', label: 'Berita & Event', href: '#berita' },
  { key: 'galeri', label: 'Galeri', href: '#galeri' },
  { key: 'mitra', label: 'Mitra', href: '#mitra' },
  { key: 'faq', label: 'FAQ', href: '#faq' },
  { key: 'kontak', label: 'Kontak', href: '#kontak' },
];

export const HERO_STATS = [
  { label: 'Unit Terkelola', value: '1.240+' },
  { label: 'Keamanan', value: '24/7' },
  { label: 'Kepuasan Penghuni', value: '98%' },
];
...
export const ABOUT_PILLARS = [
  {
    ...
    title: 'Keamanan',
    description: 'Pengawasan kawasan 24 jam, buku tamu digital, dan sinyal darurat yang terhubung langsung ke petugas.',
  },
  {
    icon: 'SmileOutlined',
    title: 'Kenyamanan',
    description: 'Fasilitas terawat dan proses layanan penghuni yang cepat, tanpa antrean panjang.',
  },
  {
    icon: 'EyeOutlined',
    title: 'Transparansi',
    description: 'Riwayat tagihan, pembayaran, dan pengaduan dapat dipantau kapan saja secara real-time.',
  },
];
...
export const SERVICES = [
  {
    ...
    description: 'Bayar iuran dan tagihan bulanan secara online dengan riwayat pembayaran yang jelas.',
  },
  {
    icon: 'HomeOutlined',
    title: 'Informasi Penghuni & Unit',
    description: 'Data penghuni dan unit tercatat rapi serta mudah diakses oleh pihak yang berwenang.',
  },
  {
    icon: 'MessageOutlined',
    title: 'Pengaduan & Keluhan',
    description: 'Sampaikan keluhan seputar kawasan dan pantau status penanganannya sampai selesai.',
  },
  {
    icon: 'AlertOutlined',
    title: 'Emergency / Panic Button',
    description: 'Kirim sinyal darurat beserta lokasi Anda kepada petugas keamanan hanya dalam sekali tekan.',
  },
  {
    icon: 'CalendarOutlined',
    title: 'Booking Fasilitas',
    description: 'Pesan clubhouse, lapangan, atau ruang pertemuan secara online tanpa perlu datang ke kantor.',
  },
  {
    icon: 'SafetyOutlined',
    title: 'Informasi Keamanan',
    description: 'Pantau aktivitas keamanan kawasan dan laporan kejadian secara transparan.',
  },
  {
    icon: 'TeamOutlined',
    title: 'Pengelolaan Tamu',
    description: 'Daftarkan tamu Anda sebelum berkunjung agar proses verifikasi di gerbang lebih cepat.',
  },
  {
    icon: 'FileTextOutlined',
    title: 'Surat & Dokumen Penghuni',
    description: 'Ajukan dan unduh surat pengantar maupun dokumen kependudukan secara digital.',
  },
  {
    icon: 'NotificationOutlined',
    title: 'Pengumuman Kawasan',
    description: 'Dapatkan informasi terbaru seputar kawasan langsung melalui aplikasi.',
  },
  {
    icon: 'CarOutlined',
    title: 'Layanan Collector & Petugas',
    description: 'Petugas lapangan tercatat dan terpantau untuk memastikan pelayanan yang akuntabel.',
  },
];
...
export const EMERGENCY_STEPS = [
  { title: 'Tekan Tombol Darurat', description: 'Buka aplikasi dan tekan tombol panic button pada halaman utama penghuni.' },
  { title: 'Lokasi Terkirim Otomatis', description: 'Titik lokasi Anda dikirim otomatis ke petugas keamanan dan admin kawasan.' },
  { title: 'Menunggu Respons', description: 'Status permintaan darurat akan tampil real-time hingga direspons petugas.' },
  { title: 'Petugas Merespons', description: 'Petugas keamanan terdekat akan menuju lokasi dan memperbarui status penanganan.' },
];

export const EMERGENCY_CONTACTS = [
  { label: 'Pos Keamanan Kawasan', value: '(021) 555-0192' },
  { label: 'Ambulans Terdekat', value: '119' },
  { label: 'Pemadam Kebakaran', value: '113' },
  { label: 'Kantor Pengelola', value: '(021) 555-0100' },
];

export const PARTNERS = [
  { name: 'Bank Mitra Sejahtera' },
  { name: 'Waskita Keamanan' },
...
export const TESTIMONIALS = [
  {
    ...
    position: 'Penghuni Cluster Anggrek',
    content: 'Bayar iuran bulanan sekarang jauh lebih praktis, tinggal buka aplikasi tanpa perlu antre ke kantor pengelola.',
    rating: 5,
  },
  {
    name: 'Bapak Hendra Saputra',
    position: 'Penghuni Cluster Melati',
    content: 'Pengaduan soal lampu jalan yang mati direspons cepat, statusnya juga bisa saya pantau langsung dari aplikasi.',
    rating: 5,
  },
  {
    name: 'Ibu Siti Aminah',
    position: 'Penghuni Cluster Kenanga',
    content: 'Fitur booking clubhouse sangat membantu untuk acara keluarga, prosesnya cepat dan tidak ribet.',
    rating: 4,
  },
];
