...
Route::middleware(['auth:sanctum', 'audit'])->group(function () {
    ...
    Route::get('billings/back-range', [BillingController::class, 'backRange'])->middleware('permission:billings.prepare-back');
    ...
    Route::get('payment-schemes/{paymentScheme}/payments', [PaymentSchemeController::class, 'payments'])->middleware('permission:payment-schemes.view');
